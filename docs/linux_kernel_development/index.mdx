...
# Kernel Compilation
$ dnf install -y make clang ncurses-devel flex bison lld llvm elfutils-libelf-devel glibc-static bindgen-cli
...
:::warning
BusyBox has a bug on ARM64, we have to patch the `libbb/hasn_md5_sha.c` file atg line 1316
